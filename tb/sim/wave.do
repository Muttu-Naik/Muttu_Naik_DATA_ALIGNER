...
add wave -noupdate -group TX_FIFO /testbench/dut/core/tx_fifo/wr_ptr_push
add wave -noupdate -group TX_FIFO /testbench/dut/core/tx_fifo/wr_ptr_pop
add wave -noupdate -group TX_FIFO /testbench/dut/core/tx_fifo/push_fifo_lvl_dly
add wave -noupdate -group TX_FIFO /testbench/dut/core/tx_fifo/pop_fifo_lvl_dly
...
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/pclk
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/presetn
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/paddr
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/pwrite
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/psel
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/penable
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/pwdata
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/pready
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/prdata
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/pslverr
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_offset
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_size
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_clr
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/status_cnt_drop
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/status_rx_lvl
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/status_tx_lvl
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/rx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/rx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/tx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/tx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/max_drop
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/addr_aligned
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/wr_ctrl_is_illegal
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_size_wr_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_offset_wr_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/ctrl_rd_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_rx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_rx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_tx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_tx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_max_drop
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_rx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_rx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_tx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_tx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_max_drop
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/status_rd_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irqen_rd_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/irq_rd_val
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/edge_rx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/edge_rx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/edge_tx_fifo_empty
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/edge_tx_fifo_full
add wave -noupdate -group REGISTERS /testbench/dut/core/regs/edge_max_drop
