...
class cfs_algn_env#(int unsigned ALGN_DATA_WIDTH = 32) extends uvm_env implements uvm_ext_reset_handler;
    ...
    virtual function void connect_phase(uvm_phase phase);
      ...
      //^now vif points to the dut signals 
      ...
      //Configure the predictor with register map
      ...
      //model to scoreboard connection 
      //model generates expected behaviour and sends it to SB 
      ...
      //actual behaviour is sent by the monitor to the SB
