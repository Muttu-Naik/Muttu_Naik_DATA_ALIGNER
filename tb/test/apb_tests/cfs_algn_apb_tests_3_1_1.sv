...
class cfs_algn_apb_tests_3_1_1 extends cfs_algn_test_base;
  ...
  virtual task run_phase(uvm_phase phase);  
    ...
    // runs forever ---- generates responses from the slave side continuously.
    fork
      begin
    ...
    //CLR field of CNTL registr is made 0 ---> meaning doesnt clear the CNT_DROP
...
//now since we are making CLR field high, it should make CNT_DROP to 0
    #(200ns);
...
//now during this 10 transaction in first 5 CNT_DROP reachers 255 and for next 5 remains same since CLR is low
